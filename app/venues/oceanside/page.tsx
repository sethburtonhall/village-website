...
export default async function OceansideVenuesPage() {
  ...
  try {
    venues = await fetchVenuesWithFallback({ state: 'CA', city: 'Oceanside' });
  } catch (err) {
    ...
    <div className="min-h-screen bg-stone-50 text-foreground dark:bg-gradient-to-b dark:from-[#0a0a0a] dark:via-[#150b1f] dark:to-[#0a0a0a]">
      <BreadcrumbSchema
        items={[
          ...
          { name: 'Oceanside', url: 'https://usevillage.app/venues/oceanside' },
        ]}
      />
      <VenuesHeader />
      ...
      <main className="px-6 py-16">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mb-12 space-y-4">
            ...
            <h1 className="text-4xl font-bold md:text-5xl">Event Venues in Oceanside</h1>
            <p className="max-w-2xl text-lg text-stone-600">
              Browse unique event spaces and beachfront venues in Oceanside, California. Perfect
              for weddings, coastal events, conferences, and community gatherings.
            </p>
          </div>
          ...
          {error ? (
            ...
            <div className="rounded-lg border border-stone-200 bg-white p-8 text-center">
              <p className="text-stone-600">
                No venues available in Oceanside at this time. Please check back soon or{' '}
